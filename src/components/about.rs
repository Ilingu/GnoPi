...
impl SimpleComponent for AboutPageModel {
    ...
    view! {
        ...
        adw::AboutWindow {
            ...
            set_application_name: "GnoPi",
            set_application_icon: "logo",
            set_developer_name: "Ilingu",
            set_issue_url: "https://github.com/Ilingu/GnoPi/issues",
            set_version: config::VERSION,
            set_website: "https://github.com/Ilingu/GnoPi",
            set_comments: "A π memorization trainer",
